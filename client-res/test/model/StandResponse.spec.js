...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new BlackjackGamingService.StandResponse();
  });
  ...
  describe('StandResponse', function() {
    it('should create an instance of StandResponse', function() {
      // uncomment below and update the code to test StandResponse
      //var instance = new BlackjackGamingService.StandResponse();
      //expect(instance).to.be.a(BlackjackGamingService.StandResponse);
    });
