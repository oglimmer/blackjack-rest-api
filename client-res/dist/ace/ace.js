...
(function () {
...
}), define("ace/config", ["require", "exports", "module", "ace/lib/lang", "ace/lib/oop", "ace/lib/net", "ace/lib/dom", "ace/lib/app_config"], function (e, t, n) {
  "no use strict";

  function c(r) {
    if (!a || !a.document) return;
    f.packaged = r || e.packaged || n.packaged || a.define && define.packaged;
    var i = {},
        s = "",
    ...
    for (var c = 0; c < l.length; c++) {
      ...
      for (var m = 0, g = v.length; m < g; m++) {
        var y = v[m];
        y.name.indexOf("data-ace-") === 0 && (i[h(y.name.replace(/^data-ace-/, ""))] = y.value);
      }
  ...
  t.get = function (e) {
    ...
    if (f.hasOwnProperty(e)) f[e] = t;else if (this.setDefaultValue("", e, t) == 0) throw new Error("Unknown config key: " + e);
  ...
  var _l = function l() {
    !f.basePath && !f.workerPath && !f.modePath && !f.themePath && !Object.keys(f.$moduleUrls).length && (console.error("Unable to infer path to ace from script src,", "use ace.config.set('basePath', 'path') to enable dynamic loading of modes and themes", "or with webpack use ace/webpack-resolver"), _l = function l() {});
  };

  t.init = c, t.version = "1.5.2";
  ...
  d.$uid = 0, function () {
    ...
    r.implement(this, u), this.setDocument = function (e) {
      this.doc && this.doc.off("change", this.$onChange), this.doc = e, e.on("change", this.$onChange), this.bgTokenizer.setDocument(this.getDocument()), this.resetCaches();
    }, this.getDocument = function () {
      return this.doc;
